...
export const generateRoutineLabFirst = (courses, labCourses, numSections) => {
  const routine = {};
...
export const generatePdfLabFirst = async (routine, fileName = "routineLabFirst.pdf") => {
